...
const AddMarathons = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const end_Date = setEndDate
        const marathon_Date = setMarathonDate
        ...
        //   max_price,
        //   description,
        //   bid_count: 0, //-->input field ছাড়া একটি ইনিসিয়াল ভ্যলু
        // };
    ...
    return (
        <div className='w-full md:w-2/3 lg:w-1/2 mx-auto bg-neutral-300 p-12 my-16' >
            ...
            <h2 className="text-center mx-auto bg-blue-100 w-[520px] mt-6 p-4 text-4xl font-bold">Post A New <span className='text-orange-600'>Marathon</span> </h2>
